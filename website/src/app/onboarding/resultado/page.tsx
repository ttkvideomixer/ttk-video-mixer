...
export default function OnboardingResultPage(): JSX.Element {
  ...
  useEffect(() => {
    ...
    const frame = (): void => {
      confetti({ particleCount: 3, angle: 60, spread: 55, origin: { x: 0 }, colors: ['#fe2c55', '#fe2c55', '#ff9bb8', '#25f4ee'] })
      confetti({ particleCount: 3, angle: 120, spread: 55, origin: { x: 1 }, colors: ['#fe2c55', '#fe2c55', '#ff9bb8', '#25f4ee'] })
