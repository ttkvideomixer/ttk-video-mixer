export default function HypeBadge({ className = '' }: { className?: string }): JSX.Element {
  return (
    <div className={`relative inline-flex ${className}`}>
      ...
      <span className="inline-flex animate-hype-pulse items-center gap-2 rounded-full bg-brand-gradient px-5 py-2.5 text-xs font-extrabold uppercase tracking-wide text-black sm:text-sm">
